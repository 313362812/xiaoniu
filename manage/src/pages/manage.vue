	...
	<div class="manage">
		<el-container>
			<el-aside width="200px">
				...
				<el-menu default-active="/manage" class="el-menu-vertical-demo" background-color="rgb(50,64,87)" text-color="#fff" active-text-color="#20a0ff" router>
					...
					<el-submenu index="2">
						...
						<el-menu-item index="/manage/claim">
...
<style>
	...
	#home {
		background: rgb(50, 64, 87) !important;
	}
